    ...
    <div class="inner">
        ...
        <div class="thumbnails">
            ...
            foreach ($marcas as $id => $marca) {
                $url = $client->getUrlVideo($id)
                ?>
                <div class="box">
                    <a href="<?= $url ?>" class="image fit" title="ver video"><img src="images/<?= strtolower($marca) ?>.png" alt="logo <?= $id ?>" /></a>
                    <div class="inner">
                        <h3><a href="modelos.php?marca=<?= $id ?>&url=<?= $marca ?>" data-poptrox="ajax,600x400">Modelos <?= $marca ?></a></h3>
